...
st.set_page_config(page_title="Analyse Avis Assurance", layout="wide")
...
def entrainer_modele(_df):
    """Charge le pipeline depuis le PKL s'il existe, sinon entraine et sauvegarde."""
    pkl_path = 'sentiment_classifier.pkl'
...
@st.cache_resource
def charger_lda():
    """Charge le modele LDA et le vectoriseur depuis les PKL s'ils existent."""
...
lda_model, count_vectorizer = charger_lda()
